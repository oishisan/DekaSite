<?php
if(isset($_SESSION['aSites']['top']) && array_key_exists($_GET['do'], $_SESSION['aSites']['top']))
{
...
elseif(isset($_SESSION['aSites']['side']) && array_key_exists($_GET['do'], $_SESSION['aSites']['side']))
{
...
else
{
	...
	{
		if(isset($_SESSION['aSites']['top']) && array_key_exists($ini['Other']['site.default'], $_SESSION['aSites']['top']))
		{
		...
		elseif(isset($_SESSION['aSites']['side']) && array_key_exists($ini['Other']['site.default'], $_SESSION['aSites']['side']))
		{
